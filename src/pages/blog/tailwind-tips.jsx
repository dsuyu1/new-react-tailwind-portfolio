...
export default function TailwindTips() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6 text-primary">Styling with Tailwind CSS</h1>
      <div className="mb-4 flex gap-2 flex-wrap">
        <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-semibold">Tailwind</span>
        <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-semibold">CSS</span>
      </div>
