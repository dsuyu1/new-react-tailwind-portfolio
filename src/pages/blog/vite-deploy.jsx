...
export default function ViteDeploy() {
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-4xl font-bold mb-6 text-primary">Deploying with Vite</h1>
      <div className="mb-4 flex gap-2 flex-wrap">
        <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-semibold">Vite</span>
        <span className="bg-primary/10 text-primary px-3 py-1 rounded-full text-xs font-semibold">Deployment</span>
      </div>
