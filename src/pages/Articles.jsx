...
const articles = [
  {
    ...
    tags: ["T-Pot", "Threat Intelligence"],
  },
  {
    id: "bbbloat",
    title: "Walkthrough: PicoCTF 2022 #42 \"Bbbbloat\"",
    date: "October 6, 2025",
    content: `A step-by-step walkthrough of the PicoCTF 2022 challenge #42, 'Bbbbloat'. This writeup covers the challenge, solution, and key takeaways for malware and binary analysis beginners.`,
    url: "/blog/bbbbloat-writeup",
    image: "/articles/bbbbloat.png", // Correct path for public folder images
    tags: ["Ghidra", "Reverse Engineering", "Malware & Low-Level Analysis"],
  },
];
...
export const ArticlesPage = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <StarBackground />
      <Navbar />
      {/* Add padding between Navbar and Articles title */}
      <div className="pt-10" />
      <main>
        <section className="py-16 px-4">
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-8 items-start relative z-10 max-w-6xl mx-auto">
              {articles.map((article) => (
                <a
                  key={article.id}
                  href={article.url}
                  className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover transition duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col w-full sm:w-96 md:w-[28rem]"
