...
export const ProjectsSection = () => {
  ...
  <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          I define my featured projects as works that utilize two or more technologies to solve a problem or create something new. Here are some of my recent projects.
        </p>
